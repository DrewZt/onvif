...
import (
	...
	goonvif "github.com/DrewZt/onvif"
	"github.com/DrewZt/onvif/device"
	sdk "github.com/DrewZt/onvif/sdk/device"
	"github.com/DrewZt/onvif/xsd/onvif"
)
...
func main() {
	...
	if err != nil {
		...
		// You could use https://github.com/DrewZt/onvif/gosoap for pretty printing response
